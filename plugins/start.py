    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            if verify_status["link"] == "":
                reply_markup = None
            await message.reply(f"Your token successfully verified 🥳🎉 and valid for: 12 Hours ⏳", reply_markup=reply_markup, protect_content=False, quote=True)
            ...
            reply_markup = InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ ᴀʙᴏᴜᴛ", callback_data = "about"),
                  InlineKeyboardButton('🍁 Adult Stories', url='t.me/Unspoken_Desires')]]
            )
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                # TUT_VID = f"https://t.me/c/2115482280/4399"
